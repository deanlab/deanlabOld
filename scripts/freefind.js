var ffresults = {
   ...
   // 11/14/2015, tom@codegaucho.com
   // modified to work with bootstrap modal.  Much of the resizing and moving bits no longer needed, but have not removed all of it yet
	...
	computePos : function(rDiv)
	{
		...
		/*
		no longer needed as we use the bootstrap modal
		*/
	},
